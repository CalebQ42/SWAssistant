...
import com.apps.darkstorm.swrpg.assistant.ui.cards.MinionCard;
    ...
    public void loadMinions(){
        AsyncTask<Void,Void,Void> async = new AsyncTask<Void, Void, Void>() {
            ...
            protected Void doInBackground(Void... params) {
                ...
                if(getActivity()!=null) {
                    if (ContextCompat.checkSelfPermission(MinionList.this.getActivity(), android.Manifest.permission.READ_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {

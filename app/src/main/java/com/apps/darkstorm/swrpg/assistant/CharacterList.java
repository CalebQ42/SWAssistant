...
import com.apps.darkstorm.swrpg.assistant.ui.cards.CharacterCard;
    ...
    public void loadChars(){
        AsyncTask<Void,Void,Void> async = new AsyncTask<Void, Void, Void>() {
            ...
            protected Void doInBackground(Void... params) {
                ...
                if(getActivity()!= null) {
                    if (ContextCompat.checkSelfPermission(CharacterList.this.getActivity(), Manifest.permission.READ_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {

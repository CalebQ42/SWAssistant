...
Die ability(BuildContext context) =>
    Die(name: SW.of(context).locale.ability, sides: [
      SimpleSide(""),
      ...
      SimpleSide(SW.of(context).locale.success),
      ComplexSide(parts: [
        ComplexSidePart(name: SW.of(context).locale.advantage, value: 1),
        ComplexSidePart(name: SW.of(context).locale.success, value: 1)
      ]),
      ComplexSide(parts: [
        ComplexSidePart(name: SW.of(context).locale.success, value: 2)
      ]),
      ComplexSide(parts: [
        ComplexSidePart(name: SW.of(context).locale.advantage, value: 2)
      ])
    ]);
Die proficiency(BuildContext context) =>
    Die(name: SW.of(context).locale.proficiency, sides: [
      SimpleSide(""),
      SimpleSide(SW.of(context).locale.success),
      SimpleSide(SW.of(context).locale.success),
      SimpleSide(SW.of(context).locale.advantage),
...
Die difficulty(BuildContext context) =>
    Die(name: SW.of(context).locale.difficulty, sides: [
      SimpleSide(""),
      ...
      ComplexSide(parts: [
        ComplexSidePart(name: SW.of(context).locale.threat, value: 1),
        ComplexSidePart(name: SW.of(context).locale.failure, value: 1)
      ]),
      ComplexSide(parts: [
        ComplexSidePart(name: SW.of(context).locale.failure, value: 2)
      ]),
      ComplexSide(parts: [
        ComplexSidePart(name: SW.of(context).locale.threat, value: 2)
      ])
    ]);
Die challenge(BuildContext context) =>
    Die(name: SW.of(context).locale.challenge, sides: [
      SimpleSide(""),
      SimpleSide(SW.of(context).locale.failure),
      SimpleSide(SW.of(context).locale.failure),
      SimpleSide(SW.of(context).locale.threat),
...
Die boost(BuildContext context) =>
    Die(name: SW.of(context).locale.boost, sides: [
      SimpleSide(""),
      SimpleSide(""),
      SimpleSide(SW.of(context).locale.advantage),
      SimpleSide(SW.of(context).locale.success),
...
Die setback(BuildContext context) =>
    Die(name: SW.of(context).locale.setback, sides: [
      SimpleSide(""),
      SimpleSide(""),
      SimpleSide(SW.of(context).locale.failure),
      SimpleSide(SW.of(context).locale.failure),
...
Die force(BuildContext context) =>
    Die(name: SW.of(context).locale.force, sides: [
      ...
      SimpleSide(SW.of(context).locale.lightSide),
      ComplexSide(parts: [
        ComplexSidePart(name: SW.of(context).locale.lightSide, value: 2)
      ]),
      ComplexSide(parts: [
        ComplexSidePart(name: SW.of(context).locale.lightSide, value: 2)
      ]),
      ...
      ComplexSide(parts: [
        ComplexSidePart(name: SW.of(context).locale.darkSide, value: 2)
      ]),
    ]);

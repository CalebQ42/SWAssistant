...
class Weapon implements JsonSavable {
  ...
  Map<String, dynamic> toJson() => {
        ...
        "skill": skill,
        "base": skillBase,
        "Weapon Characteristics": List.generate(
            characteristics.length, (index) => characteristics[index].toJson()),
        "add brawn": addBrawn,
        "loaded": loaded,
  ...
  operator ==(other) =>
      ...
      other.range == range &&
      other.skill == skill &&
      other.skillBase == skillBase &&
      other.addBrawn == addBrawn &&
      other.loaded == loaded &&
      other.limitedAmmo == limitedAmmo &&
      other.itemState == itemState &&
      other.ammo == ammo &&
      other.firingArc == firingArc &&

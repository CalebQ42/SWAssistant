            ...
            ConstrainedBox(
                ...
                child: SingleChildScrollView(
                    ...
                    child: Padding(
                        ...
                        child: child!(context)))),
            if (buttons != null)
              _BottomButtons(builder: buttons!, messenger: messenger)
          ],
        ));
  }
...
class _BottomButtons extends StatefulWidget {
  ...
  const _BottomButtons(
      {required this.builder, required this.messenger, Key? key})
      : super(key: key);
...
class _ButtonState extends State<_BottomButtons> {
  ...
  Widget build(BuildContext context) => ButtonBar(
      alignment: MainAxisAlignment.end, children: widget.builder(context));
}

...
class WeaponCharacteristicDialog {
  ...
  WeaponCharacteristicDialog(
      {WeaponCharacteristic? characteristic, required this.onClose})
      : wc = characteristic == null
            ? WeaponCharacteristic()
            : WeaponCharacteristic.from(characteristic) {
    ...
    var valueController =
        TextEditingController(text: wc.value?.toString() ?? "");
    valueController.addListener(() {
      wc.value = int.tryParse(valueController.text);
      bot.updateButtons();
    });
    var advantageController =
        TextEditingController(text: wc.advantage?.toString() ?? "");
      ...
      child: (context) => Wrap(
        children: [
          ...
          TextField(
            ...
            decoration: InputDecoration(labelText: SW.of(context).locale.rank),
          ...
          TextField(
            ...
            decoration:
                InputDecoration(labelText: SW.of(context).locale.advNeeded),
            keyboardType: TextInputType.number,
            inputFormatters: [FilteringTextInputFormatter.digitsOnly],
          ),
        ],

...
class CriticalInjuryEditDialog {
  ...
  CriticalInjuryEditDialog({CriticalInjury? inj, required this.onClose})
    ...
    descController.addListener(() => criticalInjury.desc = descController.text);
    bot = Bottom(
      buttons: (context) => [
        TextButton(
        ...
        child: Wrap(
          children: [
            ...
            TextField(
              ...
              minLines: 1,
              decoration:
                  InputDecoration(labelText: SW.of(context).locale.desc),
            ),
            Container(height: 10),
            InputDecorator(
              decoration:
                  InputDecoration(labelText: SW.of(context).locale.severity),

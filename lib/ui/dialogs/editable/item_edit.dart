...
class ItemEditDialog {
  ...
  ItemEditDialog({required this.onClose, Item? it, required this.editable})
    ...
    descController.addListener(() => item.desc = descController.text);
    bot = Bottom(
      buttons: (context) => [
        TextButton(
          onPressed: item.name != ""
      ...
      child: (context) => Wrap(
        children: [
          ...
          TextField(
            ...
            decoration: InputDecoration(labelText: SW.of(context).locale.item),
          ),
          Container(height: 10),
          TextField(
            ...
            decoration: InputDecoration(labelText: SW.of(context).locale.count),
          ),
          Container(height: 10),
          TextField(
            inputFormatters: [FilteringTextInputFormatter.digitsOnly],
            ...
            decoration:
                InputDecoration(labelText: SW.of(context).locale.encumTotal),
          ),
          Container(height: 10),
          TextField(

...
class DonateDialog extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      children: [
        Text(
          app.locale.donoOptions,
          style: Theme.of(context).textTheme.headlineSmall,
          textAlign: TextAlign.center,
        ),
        if (!kIsWeb)
          Text(app.locale.gPlay, style: Theme.of(context).textTheme.titleLarge),
        if (!kIsWeb)
          Text(
            app.locale.gPlayDesc,
            textAlign: TextAlign.center,
          ),
        Text(app.locale.sponsors,
            style: Theme.of(context).textTheme.titleLarge),
        Text(
          app.locale.sponsorsDesc,
          textAlign: TextAlign.center,
        ),
        ButtonBar(
          children: [

      ...
      children: [
        Expanded(
          child: Column(
            ...
            children: [
              Text(app.locale.lightSide,
                  textAlign: TextAlign.center,
                  style: Theme.of(context).textTheme.titleLarge),
              Container(height: 10),
              UpDownStat(
                key: light,
                onUpPressed: () => app.prefs.destinyLight++,
                onDownPressed: () => app.prefs.destinyLight--,
        ...
        Expanded(
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.center,
            children: [
              Text(app.locale.darkSide,
                  textAlign: TextAlign.center,
                  style: Theme.of(context).textTheme.titleLarge),
              Container(height: 10),
              UpDownStat(
                key: dark,
                onUpPressed: () => app.prefs.destinyDark++,
                onDownPressed: () => app.prefs.destinyDark--,

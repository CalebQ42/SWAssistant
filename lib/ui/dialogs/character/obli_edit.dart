      ...
      child: (context) => Wrap(
        children: [
          ...
          TextField(
            ...
            decoration:
                InputDecoration(labelText: SW.of(context).locale.obligation),
          ),
          Container(height: 10),
          TextField(

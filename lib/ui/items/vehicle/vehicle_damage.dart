...
class VehicleDamage extends StatelessWidget {
  ...
  const VehicleDamage({required this.editing, required this.state, Key? key})
      : super(key: key);
                ...
                child: SizedBox(
                    ...
                    child: AnimatedSwitcher(
                      ...
                      child: !editing
                          ? Column(
                              children: [
                                Text(AppLocalizations.of(context)!.hullTrauma,
                                    textAlign: TextAlign.center),
                                UpDownStat(
                                  onUpPressed: () {
                                ...
                                Center(
                                    child: Text(AppLocalizations.of(context)!
                                        .max(vehicle.hullTraumaThresh)))
                              ],
                            )
                          : TextField(
                              controller: () {
                                var controller = TextEditingController(
                                    text: vehicle.hullTraumaThresh.toString());
                                controller.addListener(() =>
                              ...
                              decoration: InputDecoration(
                                  labelText:
                                      AppLocalizations.of(context)!.maxTrauma),
                              textAlign: TextAlign.center,
                            ),
                      transitionBuilder: (child, anim) {
                        Tween<Offset> offset;
                        if ((!editing && child is TextField) ||
                            (editing && child is Column)) {
                          offset = Tween(
                ...
                child: SizedBox(
                    ...
                    child: AnimatedSwitcher(
                      ...
                      child: !editing
                          ? Column(
                              children: [
                                Text(AppLocalizations.of(context)!.sysStress,
                                    textAlign: TextAlign.center),
                                UpDownStat(
                                  onUpPressed: () {
                                ...
                                Center(
                                    child: Text(AppLocalizations.of(context)!
                                        .max(vehicle.sysStressThresh)))
                              ],
                            )
                          : TextField(
                              controller: () {
                                var controller = TextEditingController(
                                    text: vehicle.sysStressThresh.toString());
                                controller.addListener(() =>
                              ...
                              decoration: InputDecoration(
                                  labelText:
                                      AppLocalizations.of(context)!.maxStress),
                              textAlign: TextAlign.center,
                            ),
                      transitionBuilder: (child, anim) {
                        Tween<Offset> offset;

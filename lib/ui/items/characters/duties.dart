...
class Duties extends StatelessWidget {
  ...
  const Duties({required this.refresh, required this.editing, Key? key})
      : super(key: key);
        ...
        child: Column(
            children: List.generate(
                ...
                (index) => InkResponse(
                    ...
                    child: Row(children: [
                      Expanded(child: Text(character.duties[index].name)),
                      AnimatedSwitcher(
                        child: editing
                            ? ButtonBar(
                                ...
                                children: [
                                  IconButton(
                                    ...
                                    onPressed: () {
                                      var tmp =
                                          Duty.from(character.duties[index]);
                            ...
                            : Padding(
                                child: Text(
                                    character.duties[index].value.toString()),
                    ...
                    onTap: () => Bottom(
                        child: (context) => Wrap(
                              ...
                              children: [
                                Container(height: 15),
                                Text(character.duties[index].name,
                                    style:
                                ...
                                Text(
                                  character.duties[index].value.toString() +
                                      " " +
                                      AppLocalizations.of(context)!.duty,
                                  style: Theme.of(context).textTheme.bodyText1,
                                  textAlign: TextAlign.center,
                                ),
                                Container(height: 10),
                                if (character.duties[index].desc != "")
                                  Text(character.duties[index].desc)
                              ],
                            )).show(context)))
              ..add(AnimatedSwitcher(
                ...
                child: editing
                    ? Center(
                        ...
                        onPressed: () => DutyEditDialog(onClose: (duty) {

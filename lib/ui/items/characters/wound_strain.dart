...
class WoundStrain extends StatelessWidget {
  ...
  const WoundStrain({required this.editing, required this.state, Key? key})
      : super(key: key);
          ...
          children: <Widget>[
            ...
            SizedBox(
                ...
                child: EditingText(
                  ...
                  controller: () {
                    var controller =
                        TextEditingController(text: character.soak.toString());
                ...
                child: SizedBox(
                    ...
                    child: AnimatedSwitcher(
                        ...
                        transitionBuilder: (wid, anim) {
                          Tween<Offset> offset;
                          if ((!editing && wid is Padding) ||
                              (editing && wid is Column)) {
                            offset = Tween(
                        ...
                        child: !editing
                            ...
                            : () {
                                var controll = TextEditingController(
                                    text: character.woundThresh.toString());
                                controll.addListener(() {
                                  character.woundThresh =
                                      int.parse(controll.text);
                                  character.save(context: context);
                                });
                                return Padding(
                                    child: TextField(
                    ...
                    child: AnimatedSwitcher(
                        ...
                        child: !editing
                            ? Column(children: [
                                Center(
                                  child: Text(
                                      AppLocalizations.of(context)!.strain),
                                ),
                                UpDownStat(
                            ...
                            : () {
                                var controll = TextEditingController(
                                    text: character.strainThresh.toString());
                                controll.addListener(() {
                                  character.strainThresh =
                                      int.parse(controll.text);
                                  character.save(context: context);
                                });
                                return Padding(

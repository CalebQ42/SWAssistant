...
class Obligations extends StatelessWidget {
  ...
  const Obligations({required this.refresh, required this.editing, Key? key})
      : super(key: key);
            ...
            children: List.generate(
                ...
                (index) => InkResponse(
                      ...
                      child: Row(children: [
                        ...
                        AnimatedSwitcher(
                          child: editing
                              ? ButtonBar(
                                  ...
                                  children: [
                                    IconButton(
                                      ...
                                      onPressed: () {
                                        var tmp = Obligation.from(
                                            character.obligations[index]);
                                    ...
                                    IconButton(
                                        ...
                                        constraints: const BoxConstraints(
                                            maxHeight: 40.0, maxWidth: 40.0),
                                        onPressed: () => ObligationEditDialog(
                                              obli:
                                                  character.obligations[index],
                                              onClose: (obligation) {
                                                character.obligations[index] =
                              ...
                              : Padding(
                                  child: Text(character.obligations[index].value
                                      .toString()),
                      ...
                      onTap: () => Bottom(
                          child: (context) => Wrap(
                                ...
                                children: [
                                  Container(height: 15),
                                  Text(character.obligations[index].name,
                                      style:
                                          Theme.of(context).textTheme.headline5,
                                      textAlign: TextAlign.center),
                                  Container(height: 5),
                                  Text(
                                    character.obligations[index].value
                                            .toString() +
                                        " " +
                                        AppLocalizations.of(context)!
                                            .obligation,
                                  ...
                                  Container(height: 10),
                                  if (character.obligations[index].desc != "")
                                    Text(character.obligations[index].desc)
                                ],
                              )).show(context),
                    ))
              ..add(AnimatedSwitcher(
                ...
                transitionBuilder: (child, anim) => SizeTransition(
                    sizeFactor: anim, child: child, axisAlignment: -1.0),
                child: editing
                    ? Center(
                        child: IconButton(
                        icon: const Icon(Icons.add),
                        onPressed: () =>
                            ObligationEditDialog(onClose: (obligation) {

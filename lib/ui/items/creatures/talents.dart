...
class Talents extends StatelessWidget {
  ...
  const Talents({required this.editing, required this.refresh, Key? key})
      : super(key: key);
        ...
        children: List.generate(
            ...
            (index) => InkResponse(
                            ...
                            Center(
                              child: Text(
                                AppLocalizations.of(context)!.rank +
                                    ": " +
                                    creature.talents[index].value.toString(),
                ...
                child: Row(
                  children: [
                    Expanded(
                      child: Text(creature.talents[index].name +
                          ...
                          ? ButtonBar(
                              ...
                              children: [
                                IconButton(
                                  ...
                                  onPressed: () {
                                    var temp =
                                        Talent.from(creature.talents[index]);

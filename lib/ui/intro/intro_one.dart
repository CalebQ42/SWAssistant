...
class IntroOne extends StatefulWidget {
  ...
  @override
  State<StatefulWidget> createState() => _IntroOneState();
}
  ...
  Widget build(BuildContext context) => IntroScreen(
      ...
      child: ConstrainedBox(
          ...
          child: Column(
            ...
            children: [
              Text(AppLocalizations.of(context)!.firebase,
              ...
              Text(
                AppLocalizations.of(context)!
                    .introPage1CrashReportingExplaination,
                textAlign: TextAlign.justify,
              ),
              ...
              SwitchListTile(
                  ...
                  value:
                      SW.of(context).getPreference(preferences.firebase, true),
                  onChanged: (b) {
              ...
              SwitchListTile(
                  ...
                  value: SW
                      .of(context)
                      .getPreference(preferences.crashlytics, true),
                  onChanged:
                      SW.of(context).getPreference(preferences.firebase, true)
                          ? (b) {
                              SW
                                  .of(context)
                                  .prefs
                                  .setBool(preferences.crashlytics, b);
                              setState(() {});
                            }
                          : null),
              SwitchListTile(

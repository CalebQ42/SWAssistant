...
class EditableNotes extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Scaffold(
      ...
      body: AnimatedList(
          ...
          itemBuilder: (context, index, anim) => SlideTransition(
...
class NoteCard extends StatelessWidget {
  ...
  NoteCard({Key? key, required this.index, required this.list})
      : holder = EditableContentStatefulHolder(),
        super(key: key);

  @override
  Widget build(BuildContext context) => Dismissible(
        key:
            ValueKey(index.toString() + Editable.of(context).notes[index].note),
        child: Card(
            child: Padding(
...
class NoteCardContents extends StatefulWidget with StatefulCard {
  ...
  NoteCardContents({Key? key, required this.index, required this.holder})
      : super(key: key);

...
class EditableListState extends State<EditableList> {
  ...
  Widget build(BuildContext context) {
    ...
    switch (type) {
      case -1:
        if (cat == null) {
          list = [...app.characters(), ...app.minions(), ...app.vehicles()];
        } else if (cat == "char") {
          list = app.characters();
        } else if (cat == "min") {
          list = app.minions();
        ...
        categories = List.generate(
            ...
            (index) => (index == 0)
                ...
                : (index == 1)
                    ? DropdownMenuItem<String>(
                        child:
                            Text(AppLocalizations.of(context)!.uncategorized),
                        value: "")
                    : DropdownMenuItem<String>(
    ...
    var mainList = AnimatedList(
      ...
      itemBuilder: (context, i, anim) => SlideTransition(
    ...
    return (widget.onTap == null)
            ...
            floatingActionButton: FloatingActionButton(
              ...
              onPressed: () {
                ...
                switch (type) {
                  case 0:
                    newEd = Character(
                        name: AppLocalizations.of(context)!.newCharacter,
                        saveOnCreation: true,
                        app: app);
                    break;
                  case 1:
                    newEd = Minion(
                        name: AppLocalizations.of(context)!.newMinion,
                        saveOnCreation: true,
                        app: app);
                    break;
                  default:
                    newEd = Vehicle(
                        name: AppLocalizations.of(context)!.newVehicle,
                        saveOnCreation: true,
                        app: app);
                }
                app.add(newEd);
        ...
        : Column(crossAxisAlignment: CrossAxisAlignment.stretch, children: [
            ...
            Expanded(child: ClipRect(child: mainList))
          ]);
  }
}
              ...
              onTap: () {
                ...
                if (onTap != null) {
                  ...
                  Navigator.of(context)
                      .pushNamed("/edit/" + ed.uid, arguments: ed);
                }
              },
              child: Padding(

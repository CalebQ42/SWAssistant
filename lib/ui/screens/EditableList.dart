      ...
      return Scaffold(
        ...
        floatingActionButton: FloatingActionButton(
          ...
          onPressed: (){
            switch (type){
              case 0:
                setState(() => SW.of(context).add(new Character(saveOnCreation: true, app: SW.of(context))));
                break;
              case 1:
                setState(() => SW.of(context).add(new Minion(saveOnCreation: true, app: SW.of(context))));
                break;
              case 2:
                setState(() => SW.of(context).add(new Vehicle(saveOnCreation: true, app: SW.of(context))));
                break;
            }
          }
        ),

  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        floatingActionButton: FloatingActionButton(
          onPressed: () {
            holder.getDice(context).roll().showCombinedResults(context,
                noSuccess: holder.ability == 0 &&
                    holder.proficiency == 0 &&
                    holder.difficulty == 0 &&
                    holder.challenge == 0 &&
                    holder.boost == 0 &&
                    holder.challenge == 0);
                  ...
                  Wrap(
                      ...
                      children: List<Widget>.generate(
                          ...
                          (i) => ConstrainedBox(
                              ...
                              child: DiceSelector(holder: holder, type: i)))),
                  Container(height: 10),
                      ...
                      Expanded(
                          child: TextButton(
                              onPressed: () {
                                var res = Die(
                                        name: "die",
                                        sides: List<SimpleSide>.generate(
                                            widget.sides,
                                            (i) =>
                                                SimpleSide((i + 1).toString())))
                                    .roll();
                                setState(() => result =
                                    int.tryParse(res.toString()) ?? -1);
                              },

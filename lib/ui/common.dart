...
class SWAppBar extends AppBar {
  ...
  static Map<String, Function> defFunctions = {
    ...
    "discuss": () =>
        _launchURL("https://github.com/CalebQ42/SWAssistant/discussions")
  };

  SWAppBar(BuildContext context,
      {Key? key,
      Widget? title,
      List<Widget>? additionalActions,
      List<PopupMenuItem>? additionalPopupActions,
      Map<String, Function>? popupFunctions,
      ...
      : super(
            ...
            title: title,
            actions: _getActions(context, additionalActions,
                additionalPopupActions, popupFunctions),
            bottom: bottom);
  ...
  static List<Widget> _getActions(
      ...
      <Widget>[
        ...?additionalActions,
        _getPopupMenu(
            context, additionalPopupActions ?? [], popupFunctions ?? {})
      ];

  static PopupMenuButton _getPopupMenu(
      BuildContext context,
      List<PopupMenuItem> additionalPopupActions,
      Map<String, Function> popupFunctions) {
        ...
        children: <Widget>[
          ...
          ListTile(
              ...
              onTap: () {
                Navigator.of(context).pop();
                var out =
                    SW.of(context).observatory.containsRoute(name: "/minions");
                if (out != null) {
                  Navigator.of(context).removeRoute(out);
          ...
          ListTile(
              ...
              onTap: () {
                Navigator.of(context).pop();
                var out =
                    SW.of(context).observatory.containsRoute(name: "/vehicles");
                if (out != null) {
                  Navigator.of(context).removeRoute(out);
          ...
          ListTile(
              ...
              onTap: () {
                Navigator.of(context).pop();
                var out =
                    SW.of(context).observatory.containsRoute(name: "/dice");
                if (out != null) {
                  Navigator.of(context).removeRoute(out);
          ...
          ListTile(
              ...
              onTap: () {
                Navigator.of(context).pop();
                var out =
                    SW.of(context).observatory.containsRoute(name: "/settings");
                if (out != null) {
                  Navigator.of(context).removeRoute(out);
          ...
          if (kDebugMode)
            ListTile(
                ...
                onTap: () {
                  Navigator.of(context).pop();
                  Bottom(child: (context) => const TestScreen()).show(context);
                })
        ],
      ));
}
